...
var SESSIONSLIST = [{ 'speakers': [], 'startTime': '4:30 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 1, 'name': 'Badge Pickup', 'startDate': 'THURSDAY, FEBRUARY 28', 'topic': '', 'location': 'Mainstage: Castro Theatre', 'emcee': '' }, { 'speakers': [], 'startTime': '5:30 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 2, 'name': 'Lesbians Who 12-Step', 'startDate': 'THURSDAY, FEBRUARY 28', 'topic': '', 'location': 'Mainstage: Castro Country Club at 4058 18th Street', 'emcee': '' }, { 'speakers': [], 'startTime': '6:00 PM', 'isSelected': 1, 'hasConflict': 0, 'id': 3, 'name': 'Opening Address & Tech Crawl', 'startDate': 'THURSDAY, FEBRUARY 28', 'topic': '', 'location': 'Mainstage: Castro Theatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Leanne Pittsford', 'position': 'Founder & CEO, Lesbians Who Tech & Allies', 'twitter': '@lepitts' }], 'startTime': '9:30 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 6, 'name': 'Welcome', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'GLORIOUS MORNING KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Andrea Minkow', 'position': 'Founder, Andrea Minkow Consulting', 'twitter': '@andreaminkow' }, { 'name': 'Danielle Moodie-Mills', 'position': 'VP, SKDK & Host of #WokeAF on Sirius XM', 'twitter': '@DeeTwoCents' }], 'startTime': '9:40 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 7, 'name': 'Let’s Get This Summit Started', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'GLORIOUS MORNING KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Susan Wojcicki', 'position': 'CEO, YouTube', 'twitter': '@susanwojcicki' }, { 'name': 'Kara Swisher', 'position': 'Co-founder, Recode & Columnist, The New York Times ', 'twitter': '@karaswisher' }], 'startTime': '10:15 AM', 'isSelected': 1, 'hasConflict': 0, 'id': 9, 'name': 'Fireside Chat', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'GLORIOUS MORNING KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': 'Andrea Minkow, Founder, Andrea Minkow Consulting and Danielle Moodie-Mills, VP, SKDK & Host of #WokeAF on Sirius XM' }, { 'speakers': [{ 'name': 'London Breed', 'position': 'Mayor, The City of San Francisco', 'twitter': '@LondonBreed' }], 'startTime': '10:40 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 10, 'name': 'The State of San Francisco & the Tech Industry', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'GLORIOUS MORNING KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': 'Andrea Minkow, Founder, Andrea Minkow Consulting and Danielle Moodie-Mills, VP, SKDK & Host of #WokeAF on Sirius XM' }, { 'speakers': [{ 'name': 'Jessica Newman', 'position': 'Strategic Partnerships, DarkOwl' }], 'startTime': '11:30 AM', 'isSelected': 1, 'hasConflict': 0, 'id': 12, 'name': 'Shedding Light on the Darknet: Why Monitoring Matters', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'Cybersecurity & Privacy', 'location': 'MIDNIGHT SUN', 'emcee': 'Leslie Henry, Manager & Global PMO, Deloitte' }, { 'speakers': [{ 'name': 'Somer Simpson', 'position': 'Director of Product, Quantcast', 'twitter': '@somer' }], 'startTime': '11:45 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 13, 'name': 'User Privacy: Silicon Valley Culpability & Responsibility', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'Cybersecurity & Privacy', 'location': 'MIDNIGHT SUN', 'emcee': 'Leslie Henry, Manager & Global PMO, Deloitte' }, { 'speakers': [{ 'name': 'Tiffany Dillon', 'position': 'Assistant Director, Northwestern Mutual' }], 'startTime': '12:00 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 14, 'name': 'Engineering Identity & Access Management: One Line of Defense Against Cyber Threats', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'Cybersecurity & Privacy', 'location': 'MIDNIGHT SUN', 'emcee': 'Leslie Henry, Manager & Global PMO, Deloitte' }, { 'speakers': [{ 'name': 'Tiffany Shumate', 'position': 'Director of University Programs & Partnerships, AI4ALL', 'twitter': '@TiffShumate' }], 'startTime': '2:30 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 54, 'name': 'Taking Our Rightful Places: Artificial Intelligence, Women & the Future of Work', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'Career Lessons & Pro-Tips', 'location': 'THE CAFE', 'emcee': 'Zen Mak, Head of Staffing, X, The Moonshot Factory' }, { 'speakers': [{ 'name': 'Jocelyn Matthews', 'position': 'Community Manager, Storj Labs', 'twitter': '@bffjossy' }], 'startTime': '2:45 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 55, 'name': 'I Came Here to Meet 10 Black People: Normalizing My Own Presence in Tech', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'Career Lessons & Pro-Tips', 'location': 'THE CAFE', 'emcee': 'Zen Mak, Head of Staffing, X, The Moonshot Factory' }, { 'speakers': [{ 'name': "Faith Ng'etich", 'position': 'Software Developer, Andela', 'twitter': '@faith__ngetich' }], 'startTime': '3:00 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 56, 'name': 'Crowdsourced Learning as Part of a Distributed Team', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'Career Lessons & Pro-Tips', 'location': 'THE CAFE', 'emcee': 'Zen Mak, Head of Staffing, X, The Moonshot Factory' }, { 'speakers': [{ 'name': 'Jasmine Shells', 'position': 'CEO & Co-founder, Five to Nine', 'twitter': '@BoldYou' }], 'startTime': '3:15 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 57, 'name': 'How to Scale Your Culture as You Scale Your Company', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'Career Lessons & Pro-Tips', 'location': 'THE CAFE', 'emcee': 'Zen Mak, Head of Staffing, X, The Moonshot Factory' }, { 'speakers': [{ 'name': 'Cindi Leive', 'position': 'Senior Fellow, USC, Former Editor, Glamour & Journalist', 'twitter': '@cindi_leive' }], 'startTime': '2:00 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 58, 'name': 'The Feminist Case for Entitlement', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'AFTERNOON KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Cindi Leive', 'position': 'Senior Fellow, USC, Former Editor, Glamour & Journalist' }, { 'name': 'Founder & CEO, Beautycon', 'position': 'Amy Taylor' }, { 'name': 'Red Bull North America', 'position': 'Diedra Nelson' }], 'startTime': '2:15 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 59, 'name': 'Fireside Chat: Leadership Lessons, Persistence & How to Become a Boss', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'AFTERNOON KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Dara Treseder', 'position': 'Chief Marketing Officer, Carbon', 'twitter': '@daratreseder' }, { 'name': 'Shamina Singh', 'position': 'Executive Vice President, Sustainability at Mastercard & President, Mastercard Center for Inclusive Growth', 'twitter': '@shaminasingh' }], 'startTime': '2:45 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 60, 'name': 'Fireside Chat: Scaling Innovation', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'AFTERNOON KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Alicia Garza', 'position': 'Principal, Black Futures Lab & Co-founder, #BlackLivesMatter', 'twitter': '@aliciagarza' }], 'startTime': '3:00 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 61, 'name': 'Fireside Chat', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'AFTERNOON KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Mainstage: Castrotheatre' }], 'startTime': '4:00 PM ', 'isSelected': 0, 'hasConflict': 0, 'id': 63, 'name': 'BADASS CLOSING KEYNOTES', 'startDate': 'FRIDAY, MARCH 1', 'topic': 'AFTERNOON KEYNOTES', 'location': 'Mainstage: Castrotheatre', 'emcee': '' }, { 'speakers': [{ 'name': 'Crispin Odom', 'position': 'Systems Engineer, Raytheon' }, { 'name': 'Reliability Engineer, Northrop Grumman' }], 'startTime': '11:00 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 74, 'name': 'The Importance of Reverse Mentoring for Innovation', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Your Dream Job Support', 'location': 'include.io Theatre', 'emcee': 'Kristina Blehm, Senior Administrative Assistant - Products, Splunk Carrie Bishop, Chief Digital Services Officer, City & County of San Francisco' }, { 'speakers': [{ 'name': 'Jo Balme', 'position': 'Embedded Software Engineer, Zipline International' }], 'startTime': '10:00 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 76, 'name': 'Hit the Ground Flying: Evolving Life-Saving Hardware in the Field', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Hardware & Data', 'location': 'TOAD HALL', 'emcee': 'Roz Harris, Recruiting Manager (Product, Design, & Security), Slack' }, { 'speakers': [{ 'name': 'Christine Whalen', 'position': 'Associate, Goldman Sachs' }], 'startTime': '10:15 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 77, 'name': 'Data Lineage: Lessons in Tracking & Quality-Checking Your Data Processes', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Hardware & Data', 'location': 'TOAD HALL', 'emcee': 'Roz Harris, Recruiting Manager (Product, Design, & Security), Slack' }, { 'speakers': [{ 'name': 'Mia Gil Epner', 'position': 'Software Engineer, Expanse' }], 'startTime': '10:30 AM', 'isSelected': 0, 'hasConflict': 0, 'id': 78, 'name': 'GDPR & Attribution: A Dive into WHOIS Data', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Hardware & Data', 'location': 'TOAD HALL', 'emcee': 'Roz Harris, Recruiting Manager (Product, Design, & Security), Slack' }, { 'speakers': [{ 'name': 'Marly Pierre-Louis', 'position': 'Lead UX Copywriter, Booking.com', 'twitter': '@MarlyOnella' }, { 'name': 'Melody David, Senior UX Copywriter,', 'position': 'Booking.com', 'twitter': '@MelodyMeets' }], 'startTime': '1:30 PM', 'isSelected': 1, 'hasConflict': 0, 'id': 118, 'name': "Who Do You Think You're Talking to?: Copywriting & Creative Messaging", 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Future Trends & Innovation', 'location': 'BADLANDS', 'emcee': 'KC Choice, Trust & Safety Fraud Specialist, Patreon and  Rachel Ho, Global Product Marketing Manager, SAP Analytics' }, { 'speakers': [{ 'name': 'Danielle Zephyr Malament', 'position': 'Site Reliability Engineer, Spotify' }], 'startTime': '2:00 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 119, 'name': 'A Plethora of Genders: How to Stop Alienating Your Users', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Future Trends & Innovation', 'location': 'BADLANDS', 'emcee': 'KC Choice, Trust & Safety Fraud Specialist, Patreon and  Rachel Ho, Global Product Marketing Manager, SAP Analytics' }, { 'speakers': [{ 'name': 'Cinzia Palumbo', 'position': 'Global Key Accounts Director, DJI' }], 'startTime': '2:15 PM', 'isSelected': 1, 'hasConflict': 0, 'id': 120, 'name': 'Drones: Enabling a New Generation of Work', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Future Trends & Innovation', 'location': 'BADLANDS', 'emcee': 'KC Choice, Trust & Safety Fraud Specialist, Patreon and  Rachel Ho, Global Product Marketing Manager, SAP Analytics' }, { 'speakers': [{ 'name': 'Joanna Dillon', 'position': 'Responsible Minerals & Supply Chain Sustainability, Cisco', 'twitter': '@joannadillon' }], 'startTime': '2:30 PM', 'isSelected': 1, 'hasConflict': 0, 'id': 121, 'name': 'How Blockchain Will Transform Supply Chain — From Mine to Design', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Future Trends & Innovation', 'location': 'BADLANDS', 'emcee': 'KC Choice, Trust & Safety Fraud Specialist, Patreon and  Rachel Ho, Global Product Marketing Manager, SAP Analytics' }, { 'speakers': [{ 'name': 'Luna Frank-Fischer', 'position': 'Software Engineer, Expanse', 'twitter': '@lunasofiaff' }], 'startTime': '2:45 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 122, 'name': 'What We Got Wrong About the Internet', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Future Trends & Innovation', 'location': 'BADLANDS', 'emcee': 'KC Choice, Trust & Safety Fraud Specialist, Patreon and  Rachel Ho, Global Product Marketing Manager, SAP Analytics' }, { 'speakers': [{ 'name': "D'Lovely Gibson", 'position': 'PMO Lead, Marketing Data & Technology, Delta Air Lines', 'twitter': '@lovelydoes' }], 'startTime': '3:00 PM', 'isSelected': 0, 'hasConflict': 0, 'id': 123, 'name': 'Staying Relevant in the Age of Digital Transformation', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Future Trends & Innovation', 'location': 'BADLANDS', 'emcee': 'KC Choice, Trust & Safety Fraud Specialist, Patreon and  Rachel Ho, Global Product Marketing Manager, SAP Analytics' }, { 'speakers': [{ 'name': 'Tracy Mack-Askew', 'position': 'Managing Director, Daimler Trucks' }], 'startTime': '3:15 PM', 'isSelected': 1, 'hasConflict': 0, 'id': 124, 'name': 'The Future of Trucking & Transportation: Automated & Electric', 'startDate': 'SATURDAY, MARCH 2', 'topic': 'Future Trends & Innovation', 'location': 'BADLANDS', 'emcee': 'KC Choice, Trust & Safety Fraud Specialist, Patreon and  Rachel Ho, Global Product Marketing Manager, SAP Analytics' }];
...
module.exports = __webpack_require__(/*! C:\Users\jeneeb\Documents\GitHub\LWT2019-BuildingServerlessApps\front-end\SessionsScheduler\src\main.ts */"./src/main.ts");
